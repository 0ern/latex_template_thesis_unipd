...
\begin{document}
    ...
    \clearpage{\pagestyle{plain}\cleardoublepage} 
    \input{chapters/cap1/intro_cap1} % File in cui verrà scritto il capitolo
    
    \clearpage{\pagestyle{plain}\cleardoublepage}
    \input{chapters/cap2/intro_cap2} 
    
    \clearpage{\pagestyle{plain}\cleardoublepage}
    \input{chapters/cap3/intro_cap3} 
    
    \clearpage{\pagestyle{plain}\cleardoublepage}
    \input{chapters/cap4/intro_cap4}
    ...
    \chapter*{Sitografia} \addcontentsline{toc}{chapter}{Sitografia}
